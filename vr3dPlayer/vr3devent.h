...
typedef void (vr3dcamera ::* vr_3d_event_func)(vr3devent*);
...
public:
	...
	static void vr_3d_event_set_func(vr3dcamera* inst, vr_3d_event_func f);
public:
	//获取事件类型
...
public:
	...
	vector< pair<vr3dcamera*, vr_3d_event_func> > funcs;
};
